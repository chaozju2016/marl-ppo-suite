...
import numpy as np
import torch
from buffers.light_rnn_rollout_storage import RecurrentRolloutStorage
from envs import create_env
from algos.light_rnn_mappo import LightRMAPPO
from utils.logger import Logger
from utils.reward_normalization import EfficientStandardNormalizer, EMANormalizer
# import wandb


class LightRMAPPORunner:
    """
    ...
    def __init__(self, args):
        ...
        # Create agent
        self.agent = LightRMAPPO(args, args.obs_dim, args.state_dim, args.action_dim, self.device)
        ...
        self.logger = Logger(run_name=run_name, env=env_name, algo="Light_RMAPPO")
        # Log hyperparameters
